...
class ProdutoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $regras = [
            ...
            'unidade_id' => 'exists:unidades,id', // só é valido se o valor existir na tabela unidades coluna id
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Produto $produto) //$request retorna os dados do formulário $produto retorna os dados que estavam no banco
    {
        $regras = [
            'nome' => 'required|min:3|max:40',
            'descricao' => 'required|min:3|max:2000',
